    ...
    ?>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    <u>Pengajuan Perubahan Kerja Praktik</u>
                </h1>
            ...
            <section class="content">
                <div class="row">
                    <form form method="post" action="<?php echo base_url('mahasiswa/Pendaftaran_kp/ubah_kp/' . $username) ?>" enctype="multipart/form-data">
                        <div class="col-md-12">
                            <!-- Custom Tabs (Pulled to the right) -->
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs pull-right">
                                    <li><a href="#tab_1-1" data-toggle="tab">Rangkaian Kegiatan Kerja Praktik</a></li>
                                    ...
                                    <div class="tab-pane active" id="tab_3-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" class="form-control" name="telp_mhs" value="<?= $data->telp_mhs ?>">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="alamat_mhs" maxlength="100" value="<?= $data->alamat_mhs ?>">
                                                <?php echo form_error('alamt_mhs', '<div class="text-danger small">') ?>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Semester/Tahun Akademik <span style="color: red;">*</span></label>
                                                <input type="text" class="form-control" name="semester_ta" maxlength="15" value="<?= $data->semester_ta ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="nama_lks" maxlength="100" value="<?= $data->nama_lks ?>">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="email" class="form-control" name="fax_email_lks" maxlength="45" value="<?= $data->fax_email_lks ?>">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" class="form-control" name="telp_lks" maxlength="15" value="<?= $data->telp_lks ?>">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="alamat_lks" maxlength="100" value="<?= $data->alamat_lks ?>">
                                                <?php echo form_error('alamat_lks', '<div class="text-danger small">') ?>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Nama Pembimbing Lapangan <span style="color: red;">*</span></label>
                                                <input type="text" class="form-control" name="nama_pl" maxlength="45" value="<?= $data->nama_pl ?>">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="judul" maxlength="250" value="<?= $data->judul ?>">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <textarea class="form-control" name="uraian" rows="3" maxlength="1000"><?= $data->uraian ?></textarea>
                                                <?php echo form_error('uraian', '<div class="text-danger small">') ?>
                                            </div>
                                            <div class="form-group col-md-2">
                                                <label>Perkiraan Jangka Waktu <span style="color: red;">*</span></label>
                                                <input type="date" class="form-control" name="jangka_waktu_s" placeholder="dd/mm/yyyy" value="<?= $data->jangka_waktu_s ?>">
                                            ...
                                            <div class="form-group col-md-2">
                                                <label>&nbsp;</label>
                                                <input type="date" class="form-control" name="jangka_waktu_e" value="<?= $data->jangka_waktu_e ?>">
