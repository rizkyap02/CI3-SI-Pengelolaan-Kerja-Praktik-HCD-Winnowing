...
<div class="wrapper">
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url('mahasiswa/Beranda') ?>" class="logo">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                <p style="text-transform:capitalize;"><?php echo $nama; ?> <br> NPM.<?php echo $username; ?> </p>
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url('mahasiswa/Profil') ?>" class="btn btn-default btn-flat">Profil</a>
                </div>
