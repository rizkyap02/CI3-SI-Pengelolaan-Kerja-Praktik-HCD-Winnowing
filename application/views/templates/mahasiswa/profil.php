<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form role="form" method="post" action="<?php echo base_url('mahasiswa/Profil/update') ?>">
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label>NPM</label>
                            <input type="text" name="npm" class="form-control" value="<?php echo $username ?>" required readonly>
                        </div>
                        <div class="form-group">
                            <label>Email</label>
