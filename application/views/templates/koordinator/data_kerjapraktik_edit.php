                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab_3-2">
                                <form action="<?php echo base_url("koordinator/Data_kerjapraktik/update/$kerjapraktik->npm/$kerjapraktik->id_lks") ?>" method="post" class="user">
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td>
