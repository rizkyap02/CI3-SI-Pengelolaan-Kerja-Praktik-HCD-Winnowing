...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="login-box-body">
            <form action="<?php echo base_url('lupa_katasandi/gantikatasandi')  ?>" method="post">

                <?php echo $this->session->flashdata('pesan'); ?>
                <div class="form-group has-feedback">
                    <input type="password" name="password1" id="password1" class="form-control" placeholder="Masukkan Kata Sandi">
                    <?php echo form_error('password1', '<div class="text-danger small">') ?>
                    <span class="form-control-feedback"></span>
                </div>
                <div class="form-group has-feedback">
                    <input type="password" name="password2" id="password2" class="form-control" placeholder="Masukkan Ulang Kata Sandi">
                    <?php echo form_error('password1', '<div class="text-danger small">') ?>
                    <span class="form-control-feedback"></span>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 pull-right">
                        <button type="submit" class="btn btn-primary btn-block btn-flat">Ganti Kata Sandi</button>
                    </div>
                    <!-- /.col -->
                </div>
            </form>
