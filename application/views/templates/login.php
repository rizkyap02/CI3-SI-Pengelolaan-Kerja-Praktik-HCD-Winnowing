        ...
        <div class="login-box-body">
            <form action="<?php echo base_url('login/proses_login')  ?>" method="post">
                ...
                <div class="form-group has-feedback">
                    ...
                    <?php echo form_error('password', '<div class="text-danger small">') ?>
            ...
            <a href="<?php echo base_url('Lupa_katasandi') ?>">Lupa Kata Sandi ?</a><br>
            <a href="<?php echo base_url('Registrasi') ?>" class="text-center">Pendaftaran Akun Baru ?</a>
