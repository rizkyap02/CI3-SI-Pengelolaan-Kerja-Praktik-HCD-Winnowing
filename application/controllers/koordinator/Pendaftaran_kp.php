...
class Pendaftaran_kp extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['kerjapraktik'] = $this->kp_m->tampil_data_kp_k($periode->kp)->result();

        $this->load->view('templates/koordinator/header', $data);
        $this->load->view('templates/koordinator/pendaftaran_kp', $data);
    ...
    public function info($npm)
    {
        ...
        $this->load->view('templates/koordinator/header', $data);
        $this->load->view('templates/koordinator/pendaftaran_kp_info', $data);
        $this->load->view('templates/koordinator/sidebar');
        $this->load->view('templates/koordinator/footer');
    }
    ...
    public function cek($id)
    {
        ...
        $this->load->view('templates/koordinator/header', $data);
        $this->load->view('templates/koordinator/pendaftaran_kp_cek', ['data' => $data_kp, 'results' => $results, 'time' => $time]);
        $this->load->view('templates/koordinator/sidebar');
        $this->load->view('templates/koordinator/footer');
    }
    public function edit_ver($npm)
    {
        $data = $this->user_m->ambil_data($this->session->userdata['username']);
        ...
        $data['kerjapraktik'] = $this->kp_m->tampil_data_kp($npm)->row();
        $this->load->view('templates/koordinator/header', $data);
        $this->load->view('templates/koordinator/pendaftaran_kp_edit_ver', $data);
        $this->load->view('templates/koordinator/sidebar');
        $this->load->view('templates/koordinator/footer');
    }
    public function update($npm, $id_lks)
    {
        ...
        redirect('koordinator/Pendaftaran_kp');
    }
